...
from surprise import SVD #algorithms.matrix_factorization
from surprise import KNNBaseline # compute similarity score
...
# Cross Validator vs 1 splits, random_state ~ số movie/rating mà để dành cho testSet
...
# Các thứ bên dưới là phải tính toán cho fullset, k phải mỗi trainset hay testset
