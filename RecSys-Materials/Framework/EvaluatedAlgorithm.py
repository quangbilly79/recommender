...
class EvaluatedAlgorithm: # Class chứa hàm thuật toán đơn lẻ,
    # cần dùng các hàm class từ RecommenderMetrics và EvaluationData
    ...
    def Evaluate(self, evaluationData, doTopN, n=10, verbose=True):
        metrics = {} # Đặt các kết quả từ các hàm trong RecommenderMetrics vào 1 list metrics để hiển thị
        # Compute accuracy
        if (verbose):
